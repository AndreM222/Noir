...
struct ShortcutItem: Identifiable, Hashable {
    ...
    private static let all: [ShortcutItem] = [
        ...
        ShortcutItem(
            name: "Next Tab",
            description: "Switch to next tab (right)",
            binding: "⌃⇥",
            group: "Tabs"
        ),
        ShortcutItem(
            name: "Previous Tab",
            description: "Switch to previous tab (left)",
            binding: "⌃⇧⇥",
            group: "Tabs"
        ),
        ShortcutItem(
        ...
        ShortcutItem(
            name: "Find on Page",
            description: "Search text on current page",
            binding: "⌘F",
            group: "Search"
        ),
        ShortcutItem(
            name: "Quick Search",
            description: "Focus search in address bar",
            binding: "⌘K",
            group: "Search"
        ),
        ShortcutItem(
        ...
        ShortcutItem(
            name: "Console",
            description: "Open DevTools Console",
            binding: "⌘⌥J",
            group: "Developer"
        ),
        ...
        ShortcutItem(
            name: "Tab Overview",
            description: "Show all tabs overview",
            binding: "⌘⇧\\",
            group: "Tabs"
        ),
        ShortcutItem(
...
extension ShortcutItem {
    ...
    private func keyEquivalentAndModifiers() -> (KeyEquivalent, EventModifiers) {
        ...
        let key: KeyEquivalent = if let s = scalar {
            ...
            case "\\": "\\"
            default:
                KeyEquivalent(s.lowercased().first!)
            }
        } else {
    ...
    extension ShortcutItem {
        ...
        var uiKeyCommand: UIKeyCommand {
            ...
            let command = UIKeyCommand(
                input: input,
                modifierFlags: flags,
                action: #selector(ShortcutHandler.handleKeyCommand(_:))
            )
